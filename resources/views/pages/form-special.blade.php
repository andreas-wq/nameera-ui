    ...
    <div x-data="formSpecial()" x-init="init()">
        <div class="mb-8">
            <div
                ...
                <span class="text-gray-400 dark:text-gray-500 normal-case font-semibold">Special</span>
            </div>
            <h1 class="text-2xl lg:text-3xl font-heading font-extrabold text-dark dark:text-white">
                Form Special
            </h1>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <span
                            class="ml-1 text-[10px] font-bold text-primary-mid bg-primary-bg dark:bg-primary/20 px-1.5 py-0.5 rounded-full align-middle">Flatpickr</span>
                    </label>
                    <input type="text" x-ref="harvestDate" placeholder="Pilih rentang tanggal"
                ...
                <div>
                    ...
                    <input type="text" x-ref="harvestTime" placeholder="Pilih jam"
                        class="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-2.5 text-sm font-medium text-dark dark:text-gray-100 placeholder:text-gray-400 placeholder:font-normal focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all" />
                </div>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                        No. Telepon
                        <span
                            class="ml-1 text-[10px] font-bold text-accent bg-accent-bg dark:bg-accent/20 px-1.5 py-0.5 rounded-full align-middle">IMask</span>
                    </label>
                    <input type="text" x-ref="telepon" placeholder="+62 8xx-xxxx-xxxx"
                        class="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-2.5 text-sm font-medium text-dark dark:text-gray-100 placeholder:text-gray-400 placeholder:font-normal focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" x-ref="harga" placeholder="Rp 0"
                        class="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-2.5 text-sm font-medium text-dark dark:text-gray-100 placeholder:text-gray-400 placeholder:font-normal focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all" />
                </div>
                ...
                <div class="md:col-span-2 mb-10">
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                        Catatan Produksi
                        <span
                            class="ml-1 text-[10px] font-bold text-primary-mid bg-primary-bg dark:bg-primary/20 px-1.5 py-0.5 rounded-full align-middle">Quill</span>
                    </label>
                    <div x-ref="catatan" class="bg-gray-50 dark:bg-gray-900 rounded-xl" style="min-height: 140px"></div>
                </div>
            ...
            <div class="flex items-center gap-3 mt-8 pt-6 border-t border-gray-100 dark:border-gray-700/50 relative z-20">
                <button type="button"
