...
<head>
    ...
    <title>@yield('title', 'Login - Nameera UI')</title>
    ...
    <!-- Script Dark Mode Inline (Mencegah Flash/FOUC) -->
    <script>
        (function() {
            const theme = localStorage.getItem('theme') || localStorage.getItem('color-theme');
...
<body x-data="{
    ...
    class="bg-white dark:bg-gray-900 text-gray-800 dark:text-white antialiased selection:bg-primary-light selection:text-dark transition-colors duration-300">

    <!-- Floating Dark Mode Toggle -->
    <div class="fixed top-6 left-6 z-50">
        <button type="button" @click="toggleTheme()"
            class="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors shadow-sm focus:outline-none"
            title="Toggle Dark Mode">
            <svg x-show="!isDarkMode" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 24 24">
                <path
                    d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
            </svg>
            <svg x-show="isDarkMode" x-cloak class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 24 24">
                <path
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
        ...
        <div class="relative w-full max-w-md mx-auto mb-8">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div
                    ...
                    <span class="font-bold text-gray-800 dark:text-white uppercase tracking-wider text-sm">Page Not
                        Found</span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-lg mx-auto z-10">
            <h2 class="font-heading font-bold text-2xl md:text-3xl text-dark dark:text-white mb-4">
                Ups! Kehilangan Arah?
            </h2>
